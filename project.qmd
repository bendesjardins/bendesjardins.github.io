...
The data.frame `nyc_estate` is a set of data that is a record of every building or building unit (apartment, etc.) sold in the New York City property market over a 12-month period. It is available at [https://www.kaggle.com/datasets/new-york-city/nyc-property-sales](https://www.kaggle.com/datasets/new-york-city/nyc-property-sales) for free use.
...
```{r}
ggplot(data = clean_sale) +
  geom_histogram(aes(x = log(as.numeric(`SALE PRICE`)), color = `TAX CLASS AT TIME OF SALE`), bins = 100) +
